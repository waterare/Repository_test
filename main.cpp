...
//    qputenv("QT_IM_MODULE", QByteArray("qtvirtualkeyboard"));//虚拟键盘调用
    ...
    QCoreApplication::setApplicationName("Electricity Tool");//程序名称
    QSettings set;
    bool isDark = set.value("darkMode", true).toBool();//黑色主题的界面
    //bool isDark = set.value("darkMode", false).toBool();//白色的主题界面
