...
ios | macx: {
    #TARGET = "VESC Tool"
    TARGET = Energy_Storage_$$VT_VERSION

}else: {
    android:{
        #TARGET = "vesc_tool"
        TARGET = Energy_Storage_$$VT_VERSION #安卓系统上程序的名称+版本
    }else:{

        #TARGET = vesc_tool_$$VT_VERSION
        TARGET = Energy_Storage_$$VT_VERSION #windows系统上程序的名称+版本
    }
}
...
TEMPLATE = app
#CONFIG+=release_win build_original
...
include(data_collection/data_collection.pri)
